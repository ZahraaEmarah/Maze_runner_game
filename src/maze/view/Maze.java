...
public class Maze {
	...
	public Maze()
	{
    	...
    	ammo1.setIcon(new ImageIcon("./src/pics/gun.png"));
    	toolBar.add(ammo1);
    	...
    	trump.setIcon(new ImageIcon("./src/pics/Happy.gif"));
    	toolBar.add(trump);
    	...
    	label_1 = new JLabel("");
    	label_1.setIcon(new ImageIcon("./src/pics/armour.gif"));
    	...
    	lblNewLabel.setIcon(new ImageIcon("./src/pics/destroy the world.gif"));
    	...
    	btnLoad.addActionListener(new ActionListener() {
    		public void actionPerformed(ActionEvent arg0) {
				...
				JOptionPane.showMessageDialog(null, "sorry this user does not exist ");}
